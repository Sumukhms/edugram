...
export default function Signup() {
  ...
  const postData = () => {
    ...
    if (!emailRegex.test(email)) {
      ...
      notifyA("Password must be 8-15 characters long, with uppercase, lowercase, a number and a special characters for example #,?,!");
      return;
    }
    ...
    .catch(error => {
      ...
      notifyA("Something went wrong during signup.");
    });
  };
